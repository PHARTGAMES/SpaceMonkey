...
namespace BalsaTelemetry
{
    class TelemetryExporter : MonoBehaviour
    {
        ...
        void ResetMotion(Transform playerTransform)
        {
            Vector3 position = playerTransform.position;
            Quaternion rotation = playerTransform.rotation;

            lastPosition = position;
            lastRotation = rotation.eulerAngles * ((float)Mathf.PI / 180.0f);

            lastRotVel = Vector3.one;
        }
        ...
        public void FixedUpdate()
        {
            ...
            Player localPlayer = GameLogic.LocalPlayer;

            if (localPlayer != null && localPlayer.Vehicle != null)
            {
                Vehicle playerVehicle = localPlayer.Vehicle;
                Transform playerTransform = localPlayer.Vehicle.transform;
                ...
                Vector3 velocity = playerVehicle.Rb.velocity;
                ...
                data.paused = GameLogic.Paused || GameLogic.IsSwitchingScenes || GameLogic.IsWorkshopScene;
