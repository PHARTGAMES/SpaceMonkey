...
{
    class TinyCombatArenaTelemetryProvider : GenericProviderBase
    {
        Thread t;

        public TinyCombatArenaUI ui;
        TCAData data;
        int readPort = 13371;
        ...
        void PerformInjection()
        {
            ...
            string[] processNames = new string[] { "Arena" };
            ...
            foreach(string processName in processNames)
            {
                ...
                Task.Run(delegate ()
                {
                    InjectionManager.Monitor(processName, Resources.TCATelemetry, injectionEvent, "TCATelemetry");
                });
            }
        ...
        void ReadTelemetry()
        {
            ...
            while (!IsStopped)
            {
                try
                {
                    ...
                    data = (TCAData)Marshal.PtrToStructure(alloc.AddrOfPinnedObject(), typeof(TCAData));
                    alloc.Free();
